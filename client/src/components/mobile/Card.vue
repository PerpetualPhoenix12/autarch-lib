<template>
	<v-layout column class="card">
        <v-flex>
                <a :href="`https://www.novelupdates.com/series/${formatLink(novel.title)}`" target="_blank"><v-img :src="novel.coverUrl" class="rounded">
        ...
        <v-card-text class="text">
            <div class="subheading font-weight-bold">
                <span v-if="novel.title.length > 30"> {{ novel.title.slice(0, 30) }}... </span>
