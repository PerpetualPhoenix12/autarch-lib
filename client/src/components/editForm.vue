<template>
	<v-card max-width="1200px">
		<v-card-title class="black--text">
			<span class="headline">Edit Novel</span>
		</v-card-title>
		<v-form ref="form" v-model="valid" lazy-validation>	
			...
			<v-card-actions>
				<v-btn flat color="success" class="mt-3" :loading="loading" @click="submit()" :disabled="!valid">Update Novel</v-btn>
				<v-spacer></v-spacer>
				<v-btn flat color="error" class="mt-3" @click="remove()">Delete</v-btn>
